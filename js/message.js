...
const talk =[
    ["教養ゼミ（１）の世界にようこそ！\n実は、ここにはびっくり要素があるみたいなんだ……","心臓の弱い人は注意してくれ！","操作を説明するよ。緊張しないで、チュートリアルってやつだから","W/↑で上に、A/←で左に、D/→で右、S/↓で下にそれぞれ\n移動することができる","操作方法を忘れた時は、","もし、何か気になるなと思ったらとにかくクリックしよう！！\nそうすれば、新たなページに行けるかも……？","それじゃあ、自由に探索しよう！",],
    ["教養ゼミ（１）の世界にようこそ！\n実は、ここにはびっくり要素があるみたい……","心臓の弱い人は注意してね！","それじゃあ、早速……操作を説明するね！\n緊張しないで、チュートリアルだから！","W/↑で上に、A/←で左に、D/→で右、S/↓で下にそれぞれ\n移動することができるんだ","もし、操作方法を忘れた時は……","もしも、何か気になるなと思ったらとにかくクリックしてね。\nそうすれば、新たなページに行けるかもしれないからね！","それじゃあ、一緒に探索しよ！"],
    [],
    [],
    [],
    [],
